package com.jenkins.own.wechart.util;
...
public class MenuUtil {
    ...
    public static void main(String[] args) {
        ...
        //创建菜单1 click button
        ClickButton button1 = new ClickButton("加入黑狗家族", "HEIGOU");
        //添加一级菜单1
        buttons.add(button1);

        //创建菜单2 可以包含二级子菜单
        SingleButton button2 = new SingleButton("服务");

        //创建2级子菜单1，打开页面
        ViewButton button2_1 = new ViewButton("关于我们", "https://baike.baidu.com/item/%E6%88%91%E6%9C%89%E4%B8%80%E5%8F%AA%E5%8F%AB%E6%8A%91%E9%83%81%E7%97%87%E7%9A%84%E9%BB%91%E7%8B%97/22047482?fr=aladdin");
        button2.getSubButton().add(button2_1);

        //创建2级子菜单1，打开页面
        ViewButton button2_2 = new ViewButton("官网地址", "https://www.baidu.com/");
        button2.getSubButton().add(button2_2);

        //创建2级子菜单3，点击事件
        ClickButton button2_3 = new ClickButton("赞一下我们", "dianzan");
        ...
        //创建菜单3 click button
        ClickButton button3 = new ClickButton("当前时间", "current_date");
        //添加一级菜单1
        buttons.add(button1);
